...
def demo_redirect():
    """Convenience alias — /demo takes visitors straight to the full-page chat client."""
    return RedirectResponse(url="/ui")


# Serves the marketing landing page (landing/index.html + assets) at the site root.
# Mounted last and after every API route above, so those routes still win first
# and anything else (/, /style.css, /script.js, /chat-widget.js, ...) falls through
# to the static landing files.
